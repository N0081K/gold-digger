...
def http_api_logger(func):
    ...
    def wrapper(api_route, req, resp, *args, **kwargs):
        ...
        try:
            ...
            logger.warning(
                "Wrong parameter was sent in API request %s.",
                func.__name__,
                extra={
                    "request_method": req.method,
                    "request_url": req.url,
            ...
            logger.warning(
                "Missing parameter in API request %s.",
                func.__name__,
                extra={
                    "request_method": req.method,
                    "request_url": req.url,
            ...
            logger.exception(
                "Exception raised on API request %s.",
                func.__name__,
                extra={
                    "request_method": req.method,
                    "request_url": req.url,
            ...
            resp.text = json.dumps(
                {
                    "error": "Unexpected error. If the problem persists contact our support with trace ID 'golddigger." + logger.extra["flow_id"] + "' please.",
                },
            )
